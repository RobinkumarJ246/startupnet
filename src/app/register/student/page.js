...
export default function StudentRegistration() {
  ...
  const [formData, setFormData] = useState({
    ...
    fullName: '',
    university: '',
    isUniversityCollege: false, // New field to check if university is a college
    college: '',
    graduationYear: '',
    course: '',
    major: '',
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              id="fullName" 
              name="fullName" 
              className={`py-3 px-4 pl-10 block w-full border ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              id="university" 
              name="university" 
              className={`py-3 px-4 pl-10 block w-full border ${formErrors.university ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                id="college" 
                name="college" 
                className={`py-3 px-4 pl-10 block w-full border ${formErrors.college ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                id="graduationYear"
                name="graduationYear"
                className={`py-3 px-4 pl-10 block w-full border ${formErrors.graduationYear ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                id="course"
                name="course"
                className={`py-3 px-4 pl-10 block w-full border ${formErrors.course ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              id="major" 
              name="major" 
              className={`py-3 px-4 pl-10 block w-full border ${formErrors.major ? 'border-red-500' : 'border-gray-300'} rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
