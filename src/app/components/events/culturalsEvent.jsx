// app/host-event/components/CulturalEventForm.js
export function CulturalEventForm({ onSubmit }) {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      onSubmit({ ...formData, eventType: 'cultural' });
    };
  
    const culturalCategories = [
      'Dance', 'Drama', 'Music', 'Art', 'Fashion', 'Literature', 'Photography', 'Film', 'Other'
    ];
  
    return (
      <form onSubmit={handleSubmit} className="p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Cultural Event Details</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
            />
            <label htmlFor="noParticipantLimit" className="ml-2 block text-sm text-gray-700">
